...
write.csv(bias, "Data/bias5.csv")
write.csv(coverage, "Data/coverage5.csv")
write.csv(endogeneity, "Data/endo5.csv")

auxbias <- mad1$results[, 1:4]
auxcoverage <- mad1$coverage[,1:4]
write.csv(auxcoverage, "Data/auxbias5.csv")
write.csv(auxbias, "Data/auxcoverage5.csv")